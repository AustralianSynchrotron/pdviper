...
try:
    ...
    import kiva.reportlab.pdfbase.pdfmetrics as pdfmetrics
    import kiva.reportlab.pdfbase._fontdata as _fontdata
    _reportlab_loaded = 1
except ImportError:
    from kiva import pdfmetrics
    from kiva import _fontdata
    _reportlab_loaded = 0
