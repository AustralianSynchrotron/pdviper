...
from pdviper.gui.xy_plot.panel import XyPlotPanel
from pdviper.gui.xy_plot.abstract_widget import XyPlotWidget
...
verify_class_implements_abc(WidgetMock, XyPlotWidget)
...
def test_xy_plot_panel_enables_saving_figure(qtbot, mocker, mock_getSaveFileName):
...
def test_xy_plot_panel_enables_selecting_other_formats(qtbot, mocker, mock_getSaveFileName):
    mocker.patch.object(WidgetMock, 'export_image', autospec=True)
    selected_path = '/tmp/imagename1.png'
...
def test_xy_plot_panel_with_no_image_formats(qtbot, mocker):
